...
public class TaskSenseValidationServlet extends BaseServlet 
{
	 ...
	 */
	private final static String PATH = "WEB-INF/resources/task/senseValidation.csv";
	/**
	 * Parametri da salvare nel database.
	 */
	private final static List<String> PARAMETERS = List.of("word", "example", "sense", "response");
	/**
