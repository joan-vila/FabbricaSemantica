...
public class TaskWordAnnotationServlet extends BaseServlet 
{
	...
	/**
	 * Percorso del databse.
	 */
	private static final String PATH = "WEB-INF/resources/task/wordAnnotation.csv";
	/**
	 * Parametri da salvere nel database.
	 */
	private static final List<String> parameters = List.of("description", "word");
	/**
